...
<head>
    ...
    <title>Creative Computers</title>
...
$cart_table = mysqli_query($dbconn,"SELECT sum(total) FROM order_details WHERE user_id='$user_id' AND order_id=''") or die(mysqli_error());
       $cart_count = mysqli_num_rows($cart_table);
        ...
        while ($cart_row = mysqli_fetch_array($cart_table)) {
           ...
           echo '<br>';
           echo ' tracking number: '.$track_num.' | ';  
           echo '<br>';
           echo 'Total: Rs: '.$total.' | ';
           echo '<br>';
           echo 'Tax: Rs: '.$tax.' | '; 
...
$query = "INSERT INTO orders (user_id, track_num, firstname,  lastname, email, contact, shipping_add, order_date, status, totalprice, tax) 
...
<footer class="footer" data-background-color="black">
            <div class="container">
                ...
                <div class="copyright">
                    ...
                    </script>, Designed and Coded by Yaseen Khan and Zaid Jan.
                </div>
            </div>
        </footer>
    </div>
